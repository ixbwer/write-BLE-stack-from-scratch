/*
 * BLE PHY First Anchor Demo — 公共类型、常量与全局变量声明
 *
 * 相比 03_phy_connect_ind 新增:
 *   - struct anchor_tracker: 锚点追踪
 *   - 锚点计算相关常量 (WIN_DELAY, EVENT_JITTER, ...)
 *   - 连接态变量 (tx_sn, rx_nesn, conn_event_counter, ...)
 *   - 数据 PDU 缓冲区
 *
