/*
 * BLE PHY LL Procedures Demo — 公共类型、常量与全局变量声明
 *
...
/*===========================================================================
 * LL Procedure 追踪 — Instant 机制
 *
 * BLE Core Spec Vol 6, Part B, 5.1.1:
 *   某些 LL Control PDU 携带一个 "Instant" 字段(uint16_t),
 *   表示新参数将在 connEventCounter == Instant 时生效。
 *   在 Instant 到达之前, 继续使用旧参数。
 *===========================================================================*/
