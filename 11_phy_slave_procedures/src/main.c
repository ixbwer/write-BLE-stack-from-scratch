...
uint8_t adv_data[ADV_DATA_LEN_MAX] = {
	0x02, 0x01, 0x06,
	0x09, 0x09, 'S', 'L', 'V', '-', 'P', 'R', 'O', 'C'
};
uint8_t adv_data_len = 13;
...
int main(void)
{
	printk("\n");
	printk("===================================================\n");
	printk("  BLE PHY Slave Procedures Demo\n");
	printk("  Slave-Initiated LL Control PDUs\n");
	printk("  CONN_PARAM_REQ after %ds, TERMINATE after %ds\n",
	       SLAVE_CONN_PARAM_REQ_DELAY_S, SLAVE_TERMINATE_DELAY_S);
	printk("===================================================\n");
